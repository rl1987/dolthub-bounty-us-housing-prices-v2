...
class ColumbusSpider(scrapy.Spider):
    ...
    start_urls = [
        "https://publicaccess.columbusga.org/Search/Disclaimer.aspx?FromUrl=../search/advancedsearch.aspx?mode=advanced",
    ...
    def parse_property_land_page(self, response):
        ...
        sales_link = response.xpath(
            '//a[./span[text()="Sales Information"]]/@href'
        ).get()
        yield response.follow(
            sales_link,
            meta={"item": item},
